...
def main():
    ...
    vw_ss = get_video_writer(f"{RESULTS_PATH}/sum_ss.mp4", (640,480))
    for i, sim_dict in enumerate(sim_dict_list):
        ...
        plt.title(f"Stress-Strain Response (Iteration {i+1})")
    ...
    vw_rt = get_video_writer(f"{RESULTS_PATH}/sum_rt.mp4", (640,480))
