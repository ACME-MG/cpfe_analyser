...
from __common__.plotter import save_plot, define_legend, Plotter
...
def main() -> None:
    ...
    # Format and save IPF
    define_legend(["silver", "green", "red"], ["Experiment", "Calibration", "Validation"], ["scatter", "scatter", "scatter"])
